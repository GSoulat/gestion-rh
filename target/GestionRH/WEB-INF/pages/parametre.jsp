...
<jsp:include page="navbar.jsp"></jsp:include>
	<nav class="menu">
		<ol>
			<li class="menu-item"><a href="#0">Accueil</a>
			<li class="menu-item"><a href="#0">Manager</a>
				<ol class="sub-menu">
					<li class="menu-item"><a href="listmanager">Liste des
							Managers</a></li>
<!-- 					<li class="menu-item"><a href="ajoutermanager.html">Ajouter -->
<!-- 							un Manager</a></li> -->
				</ol></li>
			<li class="menu-item"><a href="#0">Employee</a>
				<ol class="sub-menu">
					<li class="menu-item"><a href="listemployer">Liste
							des Employees</a></li>
					<li class="menu-item"><a href="ajouteremployer">Ajouter
							un Employee</a></li>
				</ol></li>
			<li class="menu-item"><a href="parametre">Parametre</a></li>
			<li class="menu-item"><a href="qui">Qui sommes nous ?</a></li>
